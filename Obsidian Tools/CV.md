...
\begin{highlights}
    ...
    \begin{highlightsforbulletentries}
        \item Z-Score: 2.662
        \item District Rank: 34
        \item Island Rank: 63
        \item Combined Mathematics - A
        \item Physics - A
        \item Chemistry - A
        \item General English - A
...
\begin{highlightsforbulletentries}
    \item \textbf{Aththatu – Ecommerce Platform (Group Project)}
    \begin{highlightsforbulletentries}
        \item \textbf{Description:} Mobile application for home entrepreneurs to sell products online, with integrated state management and backend services.
        \item \textbf{Tech Stack:} Flutter, Firebase, Node.js, MySQL
    \end{highlightsforbulletentries}
    ...
    \item \textbf{Intelligent Finance Advisor (Group Project)}
    \begin{highlightsforbulletentries}
        \item \textbf{Description:} Financial planning tool with automated testing and deployment.
        \item \textbf{Tech Stack:} Next.js, DigitalOcean, Locust
    \end{highlightsforbulletentries}

    \item \textbf{MediSense – Healthcare App (Group Project)}
    \begin{highlightsforbulletentries}
        \item \textbf{Description:} Healthcare platform for booking doctor appointments and ordering medicine.
        \item \textbf{Tech Stack:} Flutter, Ballerina, MySQL
    \end{highlightsforbulletentries}
...
\begin{highlightsforbulletentries}
    ...
    \begin{highlightsforbulletentries}
        ...
        \item \textbf{Tech Stack:} ROS2 Jazzy, UDP, LiDAR sensors, Raspberry Pi
    \end{highlightsforbulletentries}
    ...
    \begin{highlightsforbulletentries}
        ...
        \item \textbf{Tech Stack:} ESP32, Node-RED, OLED, Wi-Fi
    \end{highlightsforbulletentries}
    ...
    \begin{highlightsforbulletentries}
        ...
        \item \textbf{Tech Stack:} ESP32, Python UDP Server, React
    \end{highlightsforbulletentries}

    \item \textbf{ROS 2 Robot URDF Simulations}
    \begin{highlightsforbulletentries}
        \item \textbf{Description:} URDF robot modeling with Xacro for simulation in RViz and Gazebo.
        \item \textbf{Tech Stack:} ROS2 Jazzy, Gazebo, RViz, Xacro
    \end{highlightsforbulletentries}
...
\begin{highlightsforbulletentries}
    \item \textbf{Java Game – MysticMayhem (Group Project)}
    \begin{highlightsforbulletentries}
        \item \textbf{Description:} 2D game with player movement, combat, and collectible mechanics.
        \item \textbf{Tech Stack:} Java
    \end{highlightsforbulletentries}
    ...
    \item \textbf{Sebastian – Discord Bot}
    \begin{highlightsforbulletentries}
        \item \textbf{Description:} Discord bot linked to a Git repository for project management.
        \item \textbf{Tech Stack:} Python, Discord API
    \end{highlightsforbulletentries}
\end{highlightsforbulletentries}
\end{onecolentry}
